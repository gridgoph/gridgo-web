...
const INSTALLMENTS: readonly PaymentInstallment[] = ["downpayment", "balance"];
  ...
  if (!order.payments) {
    return (
      <p className="text-body text-text-secondary m-0">
        The two installments are set up when the supplier accepts and names its
        price. Nothing is owed before then.
      </p>
    );
  }
          ...
          >
            ...
            {payment.reference ? (
              ...
              <p className="text-caption text-text-secondary m-0 mt-2">
                ...
                {payment.rejectionReason}&rdquo; The client can submit a new
                reference.
              </p>
            ) : (
