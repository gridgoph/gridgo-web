...
export default function AdminOverviewPage() {
  ...
  const derived = useMemo(() => {
    ...
    const riders = new Set(data.orders.map((o) => o.riderId).filter(Boolean) as string[]);
    ...
    <div className="flex flex-col gap-3">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <p className="text-body text-text-secondary m-0 max-w-prose">
          A snapshot from live data: orders, the pilot grant balances of clients on those
          orders, and the suppliers and riders those orders name. Accreditation, zones,
          grants and settings each have their own screen on the rail.
        </p>
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
            <section className="gg-card" aria-labelledby="credit-heading">
              ...
              <p className="text-caption text-text-muted m-0 mt-3">
                Credits are a grant ledger. They never pay for an order — issue them on
                Pilot Credits.
              </p>
            </section>
            ...
            <section className="gg-card" aria-labelledby="parties-heading">
              ...
              <p className="text-caption text-text-muted m-0 mt-3">
                Accredit a supplier or rider on Accreditation before they can be given
                work.
              </p>
            </section>
          </div>
