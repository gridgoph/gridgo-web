      ...
      <header className="gg-card flex flex-col gap-3">
        ...
        {primary || secondary.length ? (
          <div className="flex flex-col gap-2 border-t border-outline-subtle pt-3">
            {confirmDecline ? (
              <div className="gg-panel flex flex-col gap-2" role="alertdialog" aria-labelledby="decline-title">
                <p id="decline-title" className="text-body text-text-primary m-0" style={{ fontFamily: "var(--font-medium)" }}>
                  Decline this job?
                </p>
                ...
                <div className="flex flex-wrap gap-2">
                  <Button
                    ...
                    onClick={() => {
                      const decline = secondary.find((a) => a.destructive);
